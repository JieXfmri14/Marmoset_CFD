% Uses an eigenmode-based analysis to study how neuronal tracing connectome eigenmodes constrain cortical activity.
clc
clear all
...
[CC_recon_act_human,CC_recon_FC_human]= Generalizing_eigenmodes_human(mypath,n_null);
